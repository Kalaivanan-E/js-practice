...
// print all the male employee using while loop
let male_employess =0
let i =0                                      // initlization statement
...
console.log(`No of male employees: ${male_employess}`)
...
console.log(`sum of number from 1 to 5 : ${sum_of}`)