...
// write a program to print all male employees name
// write a program to print all female employee name
...
for (let emp of employees){
    if (emp.gender === "Male"){
        ...
        MaleEmployee.push(emp.ename)
    }
}
console.log(MaleEmployee)
console.log(MaleEmployee.length)


let FemaleEmployee = []
for (let emp of employees){
    if (emp.gender === "Female"){
       FemaleEmployee.push(emp.ename)
        // console.log(emp.ename)
    }
}
console.log(FemaleEmployee)
 console.log(FemaleEmployee.length)
